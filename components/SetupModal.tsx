...
import { X, Save, AlertCircle, Loader2, Info, Calendar, Link, FileText, Plus, Trash2 } from 'lucide-react';
...
const SetupModal: React.FC<SetupModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSaveAll = async () => {
    ...
    setIsSaving(true);
    try {
        // Kemaskini terus ke Google Sheet
      ...
      <div className="bg-white rounded-[2.5rem] max-w-5xl w-full shadow-2xl flex flex-col overflow-hidden animate-fadeIn h-[90vh]">
        ...
        <div className="p-8 bg-orange-600 text-white flex justify-between items-center relative">
            <div className="flex items-center gap-4">
                <div className="bg-white/20 p-3 rounded-2xl backdrop-blur-sm"><Info size={28}/></div>
                <div>
        ...
        {/* Footer */}
        <div className="p-8 bg-gray-50 flex justify-end items-center border-t border-gray-100">
